              ...
              <div className="flex flex-col gap-4">
                ...
                <div className={styles.stackedButtonGroup}>
                  <button
                    ...
                    className={choice === "no" ? styles.btnSelectStackedDark : styles.btnSelectStacked}
                  >
                    No, I will add them when I sign the documents
                  </button>
                  <button
                    onClick={() => setChoice("yes")}
                    className={choice === "yes" ? styles.btnSelectStackedDark : styles.btnSelectStacked}
                  >
                ...
                <div className="flex flex-col gap-6 animate-fadeIn">
                  <div className="flex flex-col gap-5 bg-cyan-50 rounded p-6 border border-cyan-200">
                    <div className="flex text-xl text-cyan-900 font-semibold items-center gap-3">
                      ...
                      <p className={styles.pZenco}>Please read the below carefully</p>
                    </div>
                    <div className="flex flex-col gap-4 text-cyan-800 text-sm">
                      <p className={styles.pZenco} style={{ color: 'inherit' }}>Recommended</p>
                      ...
                      <p className={styles.pZenco} style={{ color: 'inherit', marginTop: '0.5rem' }}>Alternative</p>
                  ...
                  <div className="flex flex-col gap-4">
                    <p className={styles.pZenco}>Please add the certificate provider details below.</p>

                    {providers.map((p: any) => (
                      <div key={p.id} className={`${styles.btnSelectDark} ring-0 border-0`}>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-bold text-lg text-white">{p.firstName} {p.lastName}</p>
                            <p className="text-white/80 text-sm">{p.email || "No email provided"}</p>
                            <button
                    ...
                    {providers.length === 0 && (
                      <button
                        onClick={() => setOpenModal(true)}
                        className="w-full py-4 border-2 border-dashed border-gray-300 rounded-xl flex items-center justify-center gap-2 text-gray-500 font-semibold hover:border-zenco-blue hover:text-zenco-blue hover:bg-blue-50 transition-all cursor-pointer"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                  ...
                  {providers.length > 0 && (
                    <div className="flex flex-col gap-3 animate-fadeIn">
                      <p className={styles.pZenco}>What relationship is this person to the Donor?</p>
                      <Select
                        value={relationship}
