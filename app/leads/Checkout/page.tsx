        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 space-y-2">
                  <div className="flex justify-between text-sm text-gray-500">
                    ...
                    <span>£{(fees?.our_fee_pence / 100).toFixed(2)}</span>
                  </div>
                  {fees?.opg_fee_pence > 0 && (
                    <div className="flex justify-between text-sm text-gray-500">
                      <span>OPG Registration Fees</span>
                      <span>£{(fees?.opg_fee_pence / 100).toFixed(2)}</span>
                    </div>
                  )}
                  <hr className="border-gray-100" />
                  <div className="flex justify-between text-lg font-black text-[#334a5e]">
                    <span>Total Cost</span>
                    <span>£{(fees?.total_pence / 100).toFixed(2)}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              >
                {paying ? <CircularProgress size={24} color="inherit" /> : `Pay £${(fees?.total_pence / 100).toFixed(2)} now`}
              </button>
